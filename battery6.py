...
c_deg = {'B1':0.01, 'B2':0.015, 'B3':0.02}  # €/kWh degradation cost
...
# === Objective: Total Community Cost with Degradation & TOU ===
def total_cost_rule(model):
    ...
    for t in model.T:
        ...
        total_cost += purchase - revenue + degradation
    return total_cost
...
print("Prosumer Billing with Battery Degradation & TOU:")
for i in model.I:
    total_cost = 0
    for t in model.T:
