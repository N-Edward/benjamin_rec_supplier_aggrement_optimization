...
# === Parameters ===
prosumers = ['A','B','C']
batteries = ['B1','B2']  # multiple batteries
T = 24
...
# Variables
model.P_charge = Var(model.B, model.T, domain=NonNegativeReals)
model.P_discharge = Var(model.B, model.T, domain=NonNegativeReals)
model.SoC = Var(model.B, model.T, domain=NonNegativeReals)
...
print("Prosumer Billing with Multiple Batteries:")
for i in model.I:
    total_cost = 0
    for t in model.T:
