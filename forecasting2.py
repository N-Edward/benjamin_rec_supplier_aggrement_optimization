...
# Plot battery charging/discharging and SoC for one sample scenario
sample_s = S[0]
...
plt.plot(T, soc, label='State of Charge [kWh]', color='purple', linewidth=2)

plt.xlabel('Hour of day')
plt.ylabel('Energy [kWh]')
plt.title(f'Battery Operation (Scenario {sample_s})')
plt.legend()
plt.grid(True)
plt.show()
